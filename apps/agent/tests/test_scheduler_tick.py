...
def test_live_scheduled_tick_uses_high_confidence_gate_after_daily_trade(
    tmp_path,
    monkeypatch,
) -> None:
    audit_path = tmp_path / "audit.jsonl"
    ...
    config = replace(
        ...
        live_trading_enabled=True,
        max_daily_trades=2,
        high_confidence_min_score=0.45,
        high_confidence_min_confidence=0.55,
    )
    captured = {}
